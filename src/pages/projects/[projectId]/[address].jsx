        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
              <h2 className="text-sm title-font text-gray-500 tracking-widest">3293993</h2>
              ...
              <div className="flex border-t border-gray-800 py-2">
                ...
                <span className="ml-auto text-white">{projectOverview.budget.toString()}</span>
              </div>
              <div className="flex border-t border-gray-800 py-2">
              ...
              <div className="flex">
                ...
                <button onClick={() => setIsPropsalBox(true)} className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Coat your proposal</button>
              ...
              <div className="relative inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl dark:bg-gray-900 sm:my-8 sm:w-full sm:max-w-sm sm:p-6 sm:align-middle">
                ...
                <form className="mt-4" action="#" onSubmit={handleSubmit}>
                  ...
                  <div className="mt-4 sm:flex sm:items-center sm:-mx-2">
                    <button onClick={() => setIsPropsalBox(false)} type="button" className="w-full px-4 py-2 text-sm font-medium tracking-wide text-gray-700 capitalize transition-colors duration-300 transform border border-gray-200 rounded-md sm:w-1/2 sm:mx-2 dark:text-gray-200 dark:border-gray-700 dark:hover:bg-gray-800 hover:bg-gray-100 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-40">
                      Cancel
                    </button>
